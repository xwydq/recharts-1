---
title: "recharts: An R Interface to Baidu ECharts"
output: 
  html_document: 
    toc: yes
    toc_depth: 4
...
<strong>Note:</strong> This package is still under active development. It is based on the last release of Baidu Echarts2 (v2.2.7). The documentation here always reflects the latest development version of **recharts** on [Github](https://github.com/madlogos/recharts). To install the package:
