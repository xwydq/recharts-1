...
1. [Mixed Plots](Misc_03-Mixed_Plots.html)
1. Axis/Widget Configuration
    1. Tune Series
        1. [`setSeries`](Misc_02-setSeries.html)
    1. Axis/Grid
    ...
    1. Feature Lists
        1. [`aesStyle`](Misc_01-aesStyle.html)
...
1. [Customization](Misc_04-Cust_Plots.html)
...
By now, `recharts` only supports the following misure of types:
- Cartesian coordinate charts: scatterplot/bubble, bar/column, line/area charts
- Polar coordinate charts: funnel, pie/ring charts
- Others: force, chord charts
...
---------+------+-------+-------+------------
series _1_  | list[[**1**]][_1_] | list[[**2**]][_1_] | ... | list[[**i**]][_1_]
series _2_  | list[[**1**]][_2_] | list[[**2**]][_2_] | ... | list[[**i**]][_2_]
... | ... | ... | ... | ...
series _j_  | list[[**1**]][_j_] | list[[**2**]][_j_] | ... | list[[**i**]][_j_]
